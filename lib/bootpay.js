...
module.exports = {
    ...
    subscribeBilling: function (billingKey, itemName, price, orderId, items = [], user_info = {}) {
        let _this = this;
        return new Promise(function (resolve, reject) {
            rest.post(
    ...
    destroySubscribeBillingKey: function (billingKey) {
        let _this = this;
        return new Promise(function (resolve, reject) {
            rest.del(
                _this.getUrl(['subscribe', 'billing', billingKey]),
                {
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json; charset=utf-8"',
    ...
    destroySubscribeBillingReserveCancel: function (billingKey) {
        let _this = this;
        return new Promise(function (resolve, reject) {
            rest.del(
                _this.getUrl(['subscribe', 'billing', 'reserve', billingKey]),
                {
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json; charset=utf-8"',
    ...
    certificate: function (receiptId) {
        let _this = this;
        return new Promise(function (resolve, reject) {
            rest.get(
                _this.getUrl(['certificate', receiptId]),
                {
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json; charset=utf-8"',
    ...
    remoteForm: function (remoteForm, smsPayload = {}) {
        let _this = this;
        return new Promise(function (resolve, reject) {
            rest.post(
                _this.getUrl(['app', 'rest', 'remote_form.json']),
                {
                    data: {
                        application_id: _this.applicationId,
    ...
    requestPayment: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            rest.post(
                _this.getUrl(['request', 'payment.json']),
                {
                    data: data,
                    headers: {
                        'Accept': 'application/json',
    ...
    getUserToken: function (data) {
        ...
        return new Promise(function (resolve, reject) {
            rest.post(
                _this.getUrl(['request', 'user', 'token.json']),
                {
                    data: data,
                    headers: {
                        'Accept': 'application/json',
